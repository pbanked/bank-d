...
export default function SettingsPage(){
    ...
    <>
      ...
      <Center>
        <Stack>
        <Paper w="100%" maw={900} mah={350} radius="lg" p="3vw" m="5vw" shadow="md" >
        <Group align="flex-start" justify="space-between">
            <Stack>
                <Text fw={600} fz={24}> Basic Information</Text>
                <Divider w={190}/>
            ...
            <Stack w="70%" mt={60}>
                <form onSubmit={form.onSubmit(handleSubmit)}>
                    ...
                    <TextInput size="md" label="First Name" {...form.getInputProps("firstName")} />
                    <TextInput size="md" label="Last Name" {...form.getInputProps("lastName")} />
                    </Group>
                   
                    <TextInput size="md" label="Email" {...form.getInputProps("email")} />
                    <Group  mt="md">

                    <Button size="md" variant="light" color="gray" onClick={resetChanges}>Cancel</Button>
                    <Button size="md" type="submit" color="customTeal.5">Save</Button>
                    </Group>
        ...
        <Stack>
            <Paper w="100%" mah={300} maw={900} radius="lg" p="3vw" m="5vw" shadow="lg" bg="white" >
                <Text fw={600} fz={24}> Change Password</Text>
                    <Divider w={200} mb={20}/>
                <Text fz=""> Get a secure link to update your password!</Text>
                <Button size="md" mt={10} color="customTeal.5" onClick={() => router.push("/account/update-password")}>Update Password</Button>
