  ...
  "uuid-1": [
    {
      ...
      duration: 120,
      completed: true,
      note: "Pleasant conversation",
      transcript: "Voter indicated strong support for Prop 4...",
  ...
  "uuid-2": [
    {
      ...
      completed: true,
      note: "Refused / Angry",
      transcript: "Requested removal from list.",
      author: "Mike (Volunteer)",
    },
  ],
};
                ...
                {history.map((item) => (
                  ...
                  >
                    <Text c="dimmed" size="xs">
                      By {item.author} • {item.duration}s
                    </Text>
                    {item.transcript && (
